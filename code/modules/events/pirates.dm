...
/datum/round_event/pirates/announce(fake)
	priority_announce("Входящее подпространственное сообщение. Канал безопасности доступен на всех консолях связи.", "Incoming Message", 'sound/ai/commandreport.ogg')
	if(fake)
		return
	threat = new
