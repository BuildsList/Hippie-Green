...
#define RAD_COLLECTOR_EFFICIENCY 0//80 	// radiation needs to be over this amount to get power
#define RAD_COLLECTOR_COEFFICIENT 1000//100
#define RAD_COLLECTOR_STORED_OUT 0.1//0.04	// (this*100)% of stored power outputted per tick. Doesn't actualy change output total, lower numbers just means collectors output for longer in absence of a source
